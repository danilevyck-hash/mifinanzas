    ...
    <div>
      ...
      {displayUrl ? (
        <div className="flex items-center gap-2 h-[52px]">
          ...
          <div className="flex gap-1 ml-auto">
            <button
              ...
              className="text-xs text-accent hover:text-accent-light px-2 py-1 rounded transition-colors min-h-[36px]"
            >
              Cambiar
            </button>
            {onRemove && (
        ...
        <button
          ...
          onClick={() => fileRef.current?.click()}
          disabled={uploading}
          className="w-full h-[52px] border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl flex items-center justify-center gap-2 text-sm text-muted dark:text-gray-400 hover:border-accent hover:text-accent dark:hover:border-accent dark:hover:text-accent transition-colors"
        >
          {uploading ? (
            <>
