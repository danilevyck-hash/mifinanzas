                      ...
                      <React.Fragment key={e.id}>
                        ...
                        >
                          ...
                          <button
                            ...
                            className="ml-2 min-w-[44px] min-h-[44px] flex items-center justify-center text-[#C7C7CC] active:text-[#007AFF] transition-colors flex-shrink-0"
                            title="Duplicar"
                          >
                          ...
                          <button
                            ...
                            className="min-w-[44px] min-h-[44px] flex items-center justify-center text-[#FF3B30]/70 active:text-[#FF3B30] transition-colors flex-shrink-0 disabled:opacity-50"
                            title="Eliminar"
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
